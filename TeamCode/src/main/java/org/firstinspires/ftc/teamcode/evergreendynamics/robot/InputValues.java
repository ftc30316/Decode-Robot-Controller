...
public class InputValues {
    ...
    public  static int STARTING_VELOCITY = 900;
    public static int VELOCITY_ADJUSTMENT = 5;

    // Lift flywheels
    public static int LIFT_WHEEL_WAIT_MILLISECONDS = 1750;
    ...
    // Goal positions
    public static Vector2d BLUE_GOAL_POSITION = new Vector2d(-66,-58);
