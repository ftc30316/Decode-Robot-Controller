...
public class InputValues {
    ...
    public static double CLOSED_GATE_POS_LEFT = 0.1805; //TODO Determine values
    public static double CLOSED_GATE_POS_RIGHT = 0.218; //TODO Determine values
    public static double OPEN_GATE_POS_LEFT = 0.21; //TODO Determine values
    public static double OPEN_GATE_POS_RIGHT = 0.19; //TODO Determine values
    ...
    public  static double LIFT_END_POS = 0.221;
