...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -888.79521276596; // 600.892265558; y position of the parallel encoder (in tick units)
        public double perpXTicks = -1904.5611702128; // -12285.4734042553; x position of the perpendicular encoder (in tick units)
    }
