...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1460.1635638298; // 600.892265558; y position of the parallel encoder (in tick units)
        public double perpXTicks = -2285.4734042553; // -1454.79180082; x position of the perpendicular encoder (in tick units)
    }
